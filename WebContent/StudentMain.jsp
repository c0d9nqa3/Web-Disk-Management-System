    ...
    <body class="cm-no-transition cm-1-navbar">
        ...
        <div id="global">
            <div class="container-fluid cm-container-white">
                <h2 style="margin-top:0;">欢迎登录学生<%out.print(LoginServlet.ID) ;%></h2> 
            </div>
            <div class="container-fluid">           
                <div class="row cm-fix-height">
                
                 <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Student-ViewInfo.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">                               
                                <h4>查看信息</h4> <small>查看我的信息</small>
                            </div>
                        </a>
                    </div>
                     ...
                     <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Student-ViewChangePwd.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">                               
                                <h4>修改密码</h4> <small>修改该账号的密码（学生只有权限修改密码）</small>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Student-ViewMyFile.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">                               
                                <h4>我的文件</h4> <small>查看、下载我上传的文件</small>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Student-ViewUpload.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">                                
                                <h4>上传文件</h4> <small>上传文件到个人文件夹</small>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Student-ViewHomework.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <h4>作业</h4> <small>查看提交老师上传的作业</small>
                            </div>
                        </a>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Student-ViewShare.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">
                                <h4>共享资源</h4> <small>查看校内共享网盘资源</small>
                            </div>
                        </a>
                    </div>
