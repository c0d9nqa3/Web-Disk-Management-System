...
<html lang="en">
    <head>
        ...
        <title>网盘管理系统</title>
        <%
        AdminLoginServlet.File_type="table";
        AdminDao admin=new AdminDao();
        List<Files> clist=admin.showTableFiles();
        %>
    ...
    <body class="cm-no-transition cm-1-navbar">
        ...
        <div id="global">
            <div class="container-fluid cm-container-white">
                <h2 style="margin-top:0;">申请表文档</h2> 
            </div>
            <div class="container-fluid">           
                ...
                for(Files c:clist){
                   ...
                   // out.println("<td><a href='MyFileServlet?&name="+c.getFileName()+"&id="+c.getId()+"'>下载</a></td>");
                    out.println("<td><a href='PublicResourceDownServlet?&name="+c.getFileName()+"&type="+AdminLoginServlet.File_type+"'>下载</a>");
