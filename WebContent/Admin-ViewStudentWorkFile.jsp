...
<html lang="en">
    <head>
        ...
        <title>网盘管理系统</title>
        <%
        AdminLoginServlet.File_type="stu";
        AdminDao admin=new AdminDao();
        List<Files> clist=admin.showStudentWorkFiles();
        %>
    ...
    <body class="cm-no-transition cm-1-navbar">
                ...
                <div id="cm-menu-items-wrapper">
                    <div id="cm-menu-scroller">
                        ...
                        <li class="cm-submenu">
                            ...
                            <li><a href="Student-ViewShare.jsp" class="sf-house">师生人员管理</a></li>
        ...
        <div id="global">
            <div class="container-fluid cm-container-white">
                <h2 style="margin-top:0;">学生工作文档</h2> 
            </div>
            <div class="container-fluid">           
                ...
                %>
                   ...
                   <form action="PublicResourceUpServlet" method="post" enctype="multipart/form-data">               	  	          
				  		选择一个学生工作文件: <input type="file" name="uploadFile" /><br/>
                  	<div class="button">
