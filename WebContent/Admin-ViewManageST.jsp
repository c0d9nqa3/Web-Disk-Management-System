    ...
    <body class="cm-no-transition cm-1-navbar">
        ...
        <div id="global">
            <div class="container-fluid cm-container-white">
                <h2 style="margin-top:0;">师生人员管理</h2> 
            </div>
            <div class="container-fluid">           
                <div class="row cm-fix-height">
                     <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Admin-ViewStuManage.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">                               
                                <h4>学生人员管理</h4> <small>编辑、删除或删除学生</small>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Admin-ViewTeaManage.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">                               
                                <h4>老师人员管理</h4> <small>编辑、删除或删除老师</small>
