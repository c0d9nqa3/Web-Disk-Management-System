        ...
        <div id="global">
            ...
            <div class="container-fluid">           
                <div class="row cm-fix-height">
                  姓名：<input type="text" name="name" value="${Tea.getTea_name()}" readonly></br>
                  性别：<input type="text" name="sex" value="${Tea.getSex()}" readonly></br>
                  教工号：<input type="text" name="id" value="${Tea.getTea_id()}" readonly></br>
                  密码：<input type="text" name="pwd" value="${Tea.getTea_pwd()}" readonly></br>        
                </div>              
            </div>
