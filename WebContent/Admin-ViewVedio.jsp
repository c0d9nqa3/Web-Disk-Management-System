...
<html lang="en">
    <head>
        ...
        <title>网盘管理系统</title>
        <%
        AdminLoginServlet.File_type="video";
        AdminDao admin=new AdminDao();
        List<Files> clist=admin.showVideo();
        %>
            ...
            <div class="container-fluid">           
                ...
                for(Files c:clist){
                   ...
                   // out.println("<td><a href='MyFileServlet?&name="+c.getFileName()+"&id="+c.getId()+"'>下载</a></td>");
                    out.println("<td><a href='PublicResourceDownServlet?&name="+c.getFileName()+"&type="+AdminLoginServlet.File_type+"'>下载</a>"+"<a href='/video/"+c.getFileName()+"'>观看</a>"+"<a href='PublicResourceDelServlet?&name="+c.getFileName()+"&type="+AdminLoginServlet.File_type+"&id="+c.getResource_id()+"'>删除</a>");
                ...
                %>
                   ...
                   <form action="PublicResourceUpServlet" method="post" enctype="multipart/form-data">               	  	          
				  		选择一个视频文件: <input type="file" name="uploadFile" /><br/>
                  	<div class="button">
