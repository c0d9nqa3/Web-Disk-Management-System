            ...
            <div class="container-fluid">           
                <div class="row cm-fix-height">
                	 <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Student-ViewRulesFile.jsp" class="panel panel-default thumbnail cm-thumbnail">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Student-ViewStudentWorkFile.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">                               
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="Student-ViewSubmit_Table_File.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">                               
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <a href="ST-ViewShowVideo.jsp" class="panel panel-default thumbnail cm-thumbnail">
                            <div class="panel-body text-center">                               
